...
def UI():
	...
	cmds.button(label = u"首字符->", w=sizeX/3, h=25, c=Remove(True), align = "Center")
	cmds.button(label = u"<-末尾字符", w=sizeX/3, h=25, c=Remove(False), align = "Center")
	cmds.separator(h=5, style = "none", parent = mainLayout)
	...
	cmds.button(label = u"从开头", w=50, h=20, c=RemoveChar('begin'), align = "Center", ann=u"在文本开头处删除")
	cmds.button(label = u"移除", w=sizeX/4, h=25, c=RemoveChar('all'), align = "Center", ann=u"在文本开头和末尾处删除")
	cmds.button(label = u"从末尾", w=50, h=25, c=RemoveChar('end'), align = "Center", ann=u"在文本末尾处删除")
	...
	cmds.button(label = u"添加", w=sizeX/4-10, h=25, c=PrefixSuffix(False), align = "Center")
	cmds.separator(h=5, style = "none", parent = mainLayout)
	#Group Suffix
	cmds.rowColumnLayout( numberOfRows=1, w=sizeX, parent=mainLayout, rowHeight=[(1, 20), (2, 60)], cs = [(5,5)])
	...
	cmds.button(label = u"添加", w=sizeX/4-10, h=25, c=PrefixSuffix(True), align = "Center")
	cmds.separator(w = sizeX, h=15, style = "in", parent = mainLayout)

	#Prefix
	cmds.rowColumnLayout( numberOfRows=1, w=sizeX, parent=mainLayout, rowHeight=[(1, 20), (2, 60)], cs = [(5,5)])
	cmds.button(label = "_Grp", w=sizeX/5-4, h=25, c=Suffix('_Grp'), align = "Center", ann = "Add Grp suffix", bgc = (.1,.2,.3))
	cmds.button(label = "_Geo", w=sizeX/5-4, h=25, c=Suffix('_Geo'), align = "Center", ann = "Add Geo suffix", bgc = (.1,.2,.3))
	cmds.button(label = "_Ctrl", w=sizeX/5-4, h=25, c=Suffix('_Ctrl'), align = "Center", ann = "Add Ctrl suffix", bgc = (.1,.2,.3))
	cmds.button(label = "_Jnt", w=sizeX/5-4, h=25, c=Suffix('_Jnt'), align = "Center", ann = "Add Jnt suffix", bgc = (.1,.2,.3))
	cmds.button(label = "_Drv", w=sizeX/5-4, h=25, c=Suffix('_Drv'), align = "Center", ann = "Add Drv suffix", bgc = (.1,.2,.3))
	cmds.separator(w = sizeX, h=15, style = "in", parent = mainLayout)
